...
var ItemDetailPage = /** @class */ (function () {
    ...
    ItemDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-item-detail',template:/*ion-inline-start:"/home/lifeofcoding/projects/ionicApp/src/pages/item-detail/item-detail.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>{{ item.name }}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content>\n  <div class="item-profile" text-center #profilePic [style.background-image]="\'url(\' + item.profilePic + \')\'">\n  </div>\n\n  <div class="item-detail" padding>\n    <h2>{{item.name}}</h2>\n    <p>{{item.about}}</p>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/home/lifeofcoding/projects/ionicApp/src/pages/item-detail/item-detail.html"*/
        }),
